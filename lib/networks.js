 ...
 * @param {Number} data.zaddr - The Zcash payment address prefix. The same is in ZelCash
 * @param {Number} data.zkey - The Zcash spending key prefix. The same is in ZelCash
